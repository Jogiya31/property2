...
if (count($properties) === 1) {
    ...
    $propertyText = "
        <p style='text-align:justify;'>
            The movable property, i.e., " . safe($p['property_description']) . ",
            valued at ₹" . number_format($p['property_price'], 0) . "/-,
            is held by $applicantsText.
        </p>

        <p style='text-align:justify;'>
            The said property is " . (strpos($applicantsText, '100') !== false ? "100% wholly held by the officer" : "jointly held") . "
            and was " . safe($form['acquired_disposed']) . " on " . safe($form['date_acquisition_disposed']) . ".
            $sourceText
        </p>
    ";
} else {
    ...
    foreach ($properties as $index => $p) {
        ...
        $propertyText .= "
            <p style='text-align:justify;'>
                ...
                valued at ₹" . number_format($p['property_price'], 0) . "/-,
                is held by $applicantsText. The property was " . safe($form['acquired_disposed']) . " on " . safe($form['date_acquisition_disposed']) . " 
                $sourceText
            </p>
        ";
    }
...
<div class="header">
    <strong>F. No. PF-7625/NIC/2026-Adm.II</strong><br>
    <strong>Government of India</strong><br>
    <strong>Ministry of Electronics and Information Technology</strong><br>
...
<div class="subject">
    Subject: Intimation regarding ' . safe($form['acquired_disposed']) . ' of movable Property – reg.
</div>
...
<p style="text-align:justify;">
    ...
    regarding the ' . safe($form['acquired_disposed']) . ' of movable property. 
</p>
...
<p style="text-align:justify;">
    ...
    aforementioned ' . safe($form['acquired_disposed']) . ' of movable property.
    The officer is advised to strictly adhere to the time frame and procedure prescribed under the
